...
const product = {
  ...
  highlights: ['Hand cut and sewn locally', 'Dyed with proprietary colors', 'Ultra-soft 100% cotton'],
  details: 'The 6-Pack includes two black, two white, and two gray Basic Tees...',
}
